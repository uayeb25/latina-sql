...
GO
CREATE view [ulatina].[use_in_engine]
as
select distinct
	r.[studentid],
	a.[academiccycle],
	...
	cast([finalgrade] as int) FINAL_GRADE_HIST,
	...
	case when [creditsattempled] > 0 then  r.[creditsearned] / [creditsattempled] else 0 end CE_BY_CA_HIST
...
and studenttype in ('REGRESO','NUEVO')
and a.university = 'ULATINA'
